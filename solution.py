...
def get_proper_noun():
    ...
    """
    # write your code for this function below this line
    word = input("Enter a proper noun(location,person or event):")
...
def generate():
  ...
  """.format(adjective_1 = adjective_1, adjective_2 = adjective_2, 
             verb_1 = verb_1, verb_2 = verb_2,
             plural_noun_1 = plural_noun_1, plural_noun_2 = plural_noun_2, 
             proper_noun_1 = proper_noun_1, proper_noun_2 = proper_noun_2)
